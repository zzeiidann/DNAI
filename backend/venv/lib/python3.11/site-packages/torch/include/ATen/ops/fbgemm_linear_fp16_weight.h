...
inline at::Tensor fbgemm_linear_fp16_weight(const at::Tensor & input, const at::Tensor & packed_weight, const at::Tensor & bias, at::Tensor & output) {
    return at::_ops::fbgemm_linear_fp16_weight_out::call(input, packed_weight, bias, output);
}
