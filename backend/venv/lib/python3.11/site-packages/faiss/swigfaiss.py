...
class RaBitQDistanceComputer(FlatCodesDistanceComputer):
    ...
    def lower_bound_distance(self, code):
        return _swigfaiss.RaBitQDistanceComputer_lower_bound_distance(self, code)
...
class BaseFactorsData(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    or_minus_c_l2sqr = property(_swigfaiss.BaseFactorsData_or_minus_c_l2sqr_get, _swigfaiss.BaseFactorsData_or_minus_c_l2sqr_set)
    dp_multiplier = property(_swigfaiss.BaseFactorsData_dp_multiplier_get, _swigfaiss.BaseFactorsData_dp_multiplier_set)

    def __init__(self):
        _swigfaiss.BaseFactorsData_swiginit(self, _swigfaiss.new_BaseFactorsData())
    __swig_destroy__ = _swigfaiss.delete_BaseFactorsData

# Register BaseFactorsData in _swigfaiss:
_swigfaiss.BaseFactorsData_swigregister(BaseFactorsData)
class FactorsData(BaseFactorsData):
    r"""
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    f_error = property(_swigfaiss.FactorsData_f_error_get, _swigfaiss.FactorsData_f_error_set)

    def __init__(self):
        _swigfaiss.FactorsData_swiginit(self, _swigfaiss.new_FactorsData())
    __swig_destroy__ = _swigfaiss.delete_FactorsData

# Register FactorsData in _swigfaiss:
_swigfaiss.FactorsData_swigregister(FactorsData)
class ExFactorsData(object):
    r"""
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    f_add_ex = property(_swigfaiss.ExFactorsData_f_add_ex_get, _swigfaiss.ExFactorsData_f_add_ex_set)
    f_rescale_ex = property(_swigfaiss.ExFactorsData_f_rescale_ex_get, _swigfaiss.ExFactorsData_f_rescale_ex_set)

    def __init__(self):
        _swigfaiss.ExFactorsData_swiginit(self, _swigfaiss.new_ExFactorsData())
    __swig_destroy__ = _swigfaiss.delete_ExFactorsData

# Register ExFactorsData in _swigfaiss:
_swigfaiss.ExFactorsData_swigregister(ExFactorsData)
...
def compute_vector_factors(x, d, centroid, metric_type):
    ...
    """
    return _swigfaiss.compute_vector_factors(x, d, centroid, metric_type)
...
def compute_factors_from_intermediates(norm_L2sqr, or_L2sqr, dp_oO, d, metric_type):
    ...
    """
    return _swigfaiss.compute_factors_from_intermediates(norm_L2sqr, or_L2sqr, dp_oO, d, metric_type)
...
class IndexRaBitQFastScan(IndexFastScan):
    ...
    factors_storage = property(_swigfaiss.IndexRaBitQFastScan_factors_storage_get, _swigfaiss.IndexRaBitQFastScan_factors_storage_set, doc=r"""
...
class IndexIVFRaBitQFastScan(IndexIVFFastScan):
    ...
    factors_storage = property(_swigfaiss.IndexIVFRaBitQFastScan_factors_storage_get, _swigfaiss.IndexIVFRaBitQFastScan_factors_storage_set, doc=r"""
    Extracted factors storage for batch processing
    Size: ntotal, stores factors separately from packed codes
    """)
